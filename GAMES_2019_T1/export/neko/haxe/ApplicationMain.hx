...
@:dox(hide) class ApplicationMain {
	...
	public static function main () {
		...
		lime.system.System.__registerEntryPoint ("GAMES_2019_T1", create);
		
		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed ("GAMES_2019_T1", null, 640, 480);
		#end
		#else
		create (null);
		#end
	...
	public static function create (config):Void {
		...
		app.meta["file"] = "GAMES_2019_T1";
		app.meta["name"] = "GAMES_2019_T1";
